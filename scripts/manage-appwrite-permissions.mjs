...
const config = {
  ...
  collectionIds: [
    ...
    requireEnv("APPWRITE_SMS_ACCOUNTS_COLLECTION_ID"),
    requireEnv("APPWRITE_SMS_SENDER_REQUESTS_COLLECTION_ID"),
    requireEnv("APPWRITE_SMS_TEMPLATES_COLLECTION_ID"),
    requireEnv("APPWRITE_SMS_MONTHLY_USAGE_COLLECTION_ID"),
    requireEnv("APPWRITE_SMS_SEND_LOGS_COLLECTION_ID"),
  ],
};
