...
export function AddCollectorForm() {
  return (
    <section className="mb-6 rounded-lg border border-[#dfe5ec] bg-white p-5 shadow-sm">
      <div className="mb-5">
        <p className="text-sm font-medium text-[#657386]">New collector</p>
        <h2 className="mt-1 text-lg font-semibold">Add collector profile</h2>
      </div>

      <form action={createCollectorAction} className="grid gap-4 lg:grid-cols-5">
